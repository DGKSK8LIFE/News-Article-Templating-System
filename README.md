...
- User would upload images to the grid portion and would be able to write markdown text (would use markdown engine) which could be processed on the server side and once submitted by the user, sent through the controller, and written to the model
